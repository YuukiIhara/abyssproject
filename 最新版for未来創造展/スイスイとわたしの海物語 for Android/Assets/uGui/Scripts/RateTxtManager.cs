...
public class RateTxtManager : MonoBehaviour {
	...
	public GameObject RateNumber1;
	public GameObject RateNumber2;
	public GameObject RateNumber3;
	public GameObject RateNumber4;
	...
	void Start ()
	{
		...
		// スコアのアルファ値変更
		RateNumber1.GetComponent<ScoreAlpha>().SetAlpha(false);
		RateNumber2.GetComponent<ScoreAlpha>().SetAlpha(false);
		RateNumber3.GetComponent<ScoreAlpha>().SetAlpha(false);
		RateNumber4.GetComponent<ScoreAlpha>().SetAlpha(false);
		RateNumber1.GetComponent<ScoreAlpha>().InitAlpha(0.0f);
		RateNumber2.GetComponent<ScoreAlpha>().InitAlpha(0.0f);
		RateNumber3.GetComponent<ScoreAlpha>().InitAlpha(0.0f);
		RateNumber4.GetComponent<ScoreAlpha>().InitAlpha(0.0f);
	}
	...
	void Update () {
		...
		if (Energy.GetComponent<Energy> ().GetEndFlag ())
		{
			...
			{
				// スコアの変更
				DestScore = Energy.GetComponent<Energy> ().GetEnergyRate();
				...
				// スコアのアルファ値変更
				RateNumber1.GetComponent<ScoreAlpha>().SetAlpha(true);
				RateNumber2.GetComponent<ScoreAlpha>().SetAlpha(true);
				RateNumber3.GetComponent<ScoreAlpha>().SetAlpha(true);
				RateNumber4.GetComponent<ScoreAlpha>().SetAlpha(true);
			}
			if(TimeCnt == 40)
			{
				bEndFlag = true;
